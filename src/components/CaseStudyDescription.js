		...
		return (
			<>
				...
				<div className="about-banner">
						...
						<div className="container">
							<div className="row">
								<div className="col-lg-5 col-md-9" data-aos="fade-right">
									<h4><img src={arrow4} /> CASE STUDIES</h4>
									<h1>Workflow Solution for Australia’s Leading Digitization Company</h1>
									<p>For the last decade, our client has worked in the digitisation space to help organisations transition from manual, paper-based forms and processes to automated, smart online systems.</p>
								</div>
					...
					<img className="abt-img" width="100%" src={caseBanner} />
