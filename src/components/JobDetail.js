						...
						<div className="row">
							<div className="col-lg-8 col-md-12">
								...
								<ul id="Benefits">
									...
									<li>we give the opportunity to co-create a <Link to="#">Linkletter</Link> - our original newsletter for passionate programmers</li>
									<li>we actively run a <Link to="#">corporate blog</Link> where our employees can publish their own articles on technology and business</li>
								</ul>
